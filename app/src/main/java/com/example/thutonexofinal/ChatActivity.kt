...
//    private var messageListener: ListenerRegistration? = null
//    private val PICK_IMAGE_REQUEST = 1001
//    private val PICK_FILE_REQUEST = 1002 // New request code for files
//
//    override fun onCreate(savedInstanceState: Bundle?) {
//        super.onCreate(savedInstanceState)
//
...
//
//    private fun setupInputs() {
//        findViewById<ImageButton>(R.id.attachImageButton).setOnClickListener {
//            pickImage()
//        }
//
...
//        }
//
//        // Optional: add a button for file attachments if exists
...
//        PermissionHelper.handlePermissionResult(this, requestCode, grantResults, onGranted = {
//            when(requestCode) {
//                PermissionHelper.REQUEST_MEDIA_IMAGES -> pickImage()
//                PermissionHelper.REQUEST_STORAGE -> pickFile()
//            }
//        })
//    }
//
